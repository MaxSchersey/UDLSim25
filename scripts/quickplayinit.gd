...
func _process(delta):
	...
	if $OptionButton2.get_selected_id() == 0:
		Global.Team2 = Schedule.get_team_name(1)
	if $OptionButton2.get_selected_id() == 1:
		Global.Team2 = Schedule.get_team_name(2)
	if $OptionButton2.get_selected_id() == 2:
		Global.Team2 = Schedule.get_team_name(3)
	if $OptionButton2.get_selected_id() == 3:
		Global.Team2 = Schedule.get_team_name(4)
	if $OptionButton2.get_selected_id() == 4:
		Global.Team2 = Schedule.get_team_name(5)
	if $OptionButton2.get_selected_id() == 5:
		Global.Team2 = Schedule.get_team_name(6)
	if $OptionButton2.get_selected_id() == 6:
		Global.Team2 = Schedule.get_team_name(7)
	if $OptionButton2.get_selected_id() == 7:
		Global.Team2 = Schedule.get_team_name(8)
	if $OptionButton2.get_selected_id() == 8:
		Global.Team2 = Schedule.get_team_name(9)
	if $OptionButton2.get_selected_id() == 9:
		Global.Team2 = Schedule.get_team_name(10)
	if $OptionButton2.get_selected_id() == 10:
		Global.Team2 = Schedule.get_team_name(11)
	if $OptionButton2.get_selected_id() == 11:
		Global.Team2 = Schedule.get_team_name(12)
	if $OptionButton2.get_selected_id() == 12:
		Global.Team2 = Schedule.get_team_name(13)
	if $OptionButton2.get_selected_id() == 13:
		Global.Team2 = Schedule.get_team_name(14)
	if $OptionButton2.get_selected_id() == 14:
		Global.Team2 = Schedule.get_team_name(15)
	if $OptionButton2.get_selected_id() == 15:
		Global.Team2 = Schedule.get_team_name(16)
	if $OptionButton2.get_selected_id() == 16:
		Global.Team2 = Schedule.get_team_name(17)
	if $OptionButton2.get_selected_id() == 17:
		Global.Team2 = Schedule.get_team_name(18)
	if $OptionButton2.get_selected_id() == 18:
		Global.Team2 = Schedule.get_team_name(19)
	if $OptionButton2.get_selected_id() == 19:
		Global.Team2 = Schedule.get_team_name(20)
	if $OptionButton2.get_selected_id() == 20:
		Global.Team2 = Schedule.get_team_name(21)
	if $OptionButton2.get_selected_id() == 21:
		Global.Team2 = Schedule.get_team_name(22)
	if $OptionButton2.get_selected_id() == 22:
		Global.Team2 = Schedule.get_team_name(23)
	if $OptionButton2.get_selected_id() == 23:
		Global.Team2 = Schedule.get_team_name(24)
	if $OptionButton2.get_selected_id() == 24:
		Global.Team2 = Schedule.get_team_name(25)
	if $OptionButton2.get_selected_id() == 25:
		Global.Team2 = Schedule.get_team_name(26)
	if $OptionButton2.get_selected_id() == 26:
		Global.Team2 = Schedule.get_team_name(27)
	if $OptionButton2.get_selected_id() == 27:
		Global.Team2 = Schedule.get_team_name(28)
	if $OptionButton2.get_selected_id() == 28:
		Global.Team2 = Schedule.get_team_name(29)
	if $OptionButton2.get_selected_id() == 29:
		Global.Team2 = Schedule.get_team_name(30)
	if $OptionButton2.get_selected_id() == 30:
		Global.Team2 = Schedule.get_team_name(31)
	if $OptionButton2.get_selected_id() == 31:
		Global.Team2 = Schedule.get_team_name(32)
	if $OptionButton2.get_selected_id() == 32:
		Global.Team2 = Schedule.get_team_name(33)
	if $OptionButton2.get_selected_id() == 33:
		Global.Team2 = Schedule.get_team_name(34)
	if $OptionButton2.get_selected_id() == 34:
		Global.Team2 = Schedule.get_team_name(35)
	if $OptionButton2.get_selected_id() == 35:
		Global.Team2 = Schedule.get_team_name(36)
	if $OptionButton2.get_selected_id() == 36:
		Global.Team2 = Schedule.get_team_name(37)
	if $OptionButton2.get_selected_id() == 37:
		Global.Team2 = Schedule.get_team_name(38)
	if $OptionButton2.get_selected_id() == 38:
		Global.Team2 = Schedule.get_team_name(39)
	if $OptionButton2.get_selected_id() == 39:
		Global.Team2 = Schedule.get_team_name(40)
